...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\RIME
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\RIME
    // Mac: ~/Library/Application Support/RIME
    // Unix: ~/.RIME
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "RIME";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Rime.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
    {
               ...
               fprintf(ConfFile, "port=51395\n");
               fprintf(ConfFile, "rpcport=51394\n");
               fprintf(ConfFile, "#rpcconnect=127.0.0.1\n");
               fprintf(ConfFile, "rpcallowip=127.0.0.1\n");
               fprintf(ConfFile, "addnode=206.189.223.153:51395\n");
               ...
               fprintf(ConfMNFile, "# Example: mn1 127.0.0.2:51395 63HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0");
               fclose(ConfMNFile);
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Rimed.pid"));
    ...
    if (vTimeOffsets.size() >= 5 && vTimeOffsets.size() % 2 == 1)
    {
        ...
        else
        {
            ...
            if (!fDone)
            {
                ...
                {
                    fDone = true;
                    string strMessage = _("Warning: Please check that your computer's date and time are correct! If your clock is wrong Rime will not work properly.");
